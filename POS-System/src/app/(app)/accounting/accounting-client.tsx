  ...
  return (
    <AppShell title="Accounting" subtitle="Chart of accounts, ledgers & financial statements">
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {tiles.map((t) => (
          <Link key={t.to} href={t.to} className="panel flex flex-col items-center gap-3 border-l-4 border-l-primary p-6 text-center transition-colors hover:bg-muted/40">
