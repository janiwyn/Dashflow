...
export const Route = createFileRoute("/inventory")({
  head: () => ({
    meta: [
      { title: "Inventory — Meridian POS" },
      { name: "description", content: "Track stock levels, pricing and reorder points across every product line." },
      { property: "og:title", content: "Inventory — Meridian POS" },
      { property: "og:description", content: "Track stock levels, pricing and reorder points." },
    ],
  }),
  ...
  return (
    ...
    >
      <section className="grid gap-4 sm:grid-cols-3">
        <StatCard label="Stock value" value={currency(4180000)} delta={-2.3} icon={Boxes} hint="at cost" />
