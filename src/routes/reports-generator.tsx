...
export const Route = createFileRoute("/reports-generator")({
  head: () => ({
    meta: [
      { title: "Report Generator — Meridian POS" },
      { name: "description", content: "Generate expenses, sales, debtors and payment analysis reports." },
      { property: "og:title", content: "Report Generator — Meridian POS" },
      { property: "og:description", content: "Build a custom report by type, branch and date range." },
    ],
  }),
