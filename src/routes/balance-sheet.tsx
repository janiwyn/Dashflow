...
export const Route = createFileRoute("/balance-sheet")({
  head: () => ({
    meta: [
      { title: "Balance Sheet — Meridian POS" },
      { name: "description", content: "Assets, liabilities and owner's equity at a glance." },
      { property: "og:title", content: "Balance Sheet — Meridian POS" },
      { property: "og:description", content: "Assets, liabilities and owner's equity at a glance." },
    ],
  }),
