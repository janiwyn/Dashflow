...
import { smsLogs, type SmsLog } from "@/lib/stock-data";

export const Route = createFileRoute("/sms")({
  head: () => ({
    meta: [
      { title: "SMS Alerts — Meridian POS" },
      { name: "description", content: "Send SMS notifications and review the delivery log." },
      { property: "og:title", content: "SMS Alerts — Meridian POS" },
      { property: "og:description", content: "Send and track SMS notifications." },
    ],
  }),
  component: SmsPage,
});
