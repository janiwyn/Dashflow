...
export const Route = createFileRoute("/add-business")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Register a new business tenant on the platform." },
      { property: "og:title", content: "Add Business — Super Admin" },
      { property: "og:description", content: "Register a new business tenant on the platform." },
    ],
  }),
        ...
        <form onSubmit={onSubmit} className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex gap-2 sm:col-span-2">
            ...
            <Button asChild type="button" variant="secondary" className="rounded-lg">
              <Link to="/manage-business">Cancel</Link>
            </Button>
          </div>
        </form>
      </div>
