...
export const Route = createFileRoute("/subscription")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Manage subscription start, end dates and status for every business." },
      { property: "og:title", content: "Business Subscriptions — Super Admin" },
      { property: "og:description", content: "Manage subscription start, end dates and status for every business." },
    ],
  }),
