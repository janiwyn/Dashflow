...
import { currency, receiptSample } from "@/lib/sales-ops-data";

export const Route = createFileRoute("/receipt-preview")({
  head: () => ({
    meta: [
      { title: "Receipt Preview — Meridian POS" },
      { name: "description", content: "Preview and print a customer receipt before closing out a sale." },
      { property: "og:title", content: "Receipt Preview — Meridian POS" },
      { property: "og:description", content: "Preview and print a customer receipt." },
    ],
  }),
