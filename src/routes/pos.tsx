...
import { categories, currency, products } from "@/lib/pos-data";

export const Route = createFileRoute("/pos")({
  head: () => ({
    meta: [
      { title: "Sales Terminal — Meridian POS" },
      { name: "description", content: "Fast touch-friendly checkout terminal with cart, discounts and split payments." },
      { property: "og:title", content: "Sales Terminal — Meridian POS" },
      { property: "og:description", content: "Fast touch-friendly checkout with cart and split payments." },
    ],
  }),
  component: Terminal,
});
