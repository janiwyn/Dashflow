...
import { currency, products } from "@/lib/pos-data";

export const Route = createFileRoute("/staff-dashboard")({
  head: () => ({
    meta: [
      { title: "Staff Dashboard — Meridian POS" },
      { name: "description", content: "Record sales and track your daily performance at the till." },
      { property: "og:title", content: "Staff Dashboard — Meridian POS" },
      { property: "og:description", content: "Sell products, track stock and view your sales history." },
    ],
  }),
  ...
  return (
    <AppShell title="Welcome, Peter Mwangi" subtitle="Staff dashboard · Nairobi — Main branch">
      <section className="grid gap-4 sm:grid-cols-3">
        <StatCard label="My sales today" value={currency(7680)} icon={Banknote} hint="4 receipts" />
