...
import { branches, currency, tillRemovals, tills, type Till } from "@/lib/sales-ops-data";

export const Route = createFileRoute("/till-management")({
  head: () => ({
    meta: [
      { title: "Till Management — Meridian POS" },
      { name: "description", content: "Create tills, assign staff and manage till safe removals across branches." },
      { property: "og:title", content: "Till Management — Meridian POS" },
      { property: "og:description", content: "Create tills and manage till safe removals." },
    ],
  }),
  component: TillManagementPage,
});
      ...
      <Tabs defaultValue="create" className="panel p-5">
        ...
        <TabsContent value="safes" className="mt-5 space-y-6">
          ...
          <DataTable
            ...
            columns={[
              { key: "till", header: "Till", render: (r: (typeof tillRemovals)[number]) => r.till },
