...
import { transactionsFeed } from "@/lib/accounting-data";

export const Route = createFileRoute("/add-transaction")({
  head: () => ({
    meta: [
      { title: "Transactions — Meridian POS" },
      { name: "description", content: "Auto-generated income and expense transactions across branches." },
      { property: "og:title", content: "Transactions — Meridian POS" },
      { property: "og:description", content: "Auto-generated income and expense transactions across branches." },
    ],
  }),
  component: AddTransactionPage,
});

type Row = (typeof transactionsFeed)[number];
