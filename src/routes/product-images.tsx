...
import { branches, stockProducts } from "@/lib/stock-data";

export const Route = createFileRoute("/product-images")({
  head: () => ({
    meta: [
      { title: "Product Images — Meridian POS" },
      { name: "description", content: "Upload and manage product photos used across the POS and catalogue." },
      { property: "og:title", content: "Product Images — Meridian POS" },
      { property: "og:description", content: "Manage product images per branch." },
    ],
  }),
