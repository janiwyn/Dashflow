...
import { currency, sales, expenses } from "@/lib/pos-data";

export const Route = createFileRoute("/income-statement")({
  head: () => ({
    meta: [
      { title: "Income Statement — Meridian POS" },
      { name: "description", content: "Profit and loss summary of income against expenses." },
      { property: "og:title", content: "Income Statement — Meridian POS" },
      { property: "og:description", content: "Profit and loss summary of income against expenses." },
    ],
  }),
