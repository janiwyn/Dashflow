...
import { branches, employees, systemUsers, type Employee as EmployeeType } from "@/lib/hr-data";

export const Route = createFileRoute("/employee")({
  head: () => ({
    meta: [
      { title: "Employee Record — Meridian POS" },
      { name: "description", content: "Edit an individual employee record, branch and compensation." },
      { property: "og:title", content: "Employee Record — Meridian POS" },
      { property: "og:description", content: "Edit an individual employee record, branch and compensation." },
    ],
  }),
