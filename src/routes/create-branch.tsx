...
export const Route = createFileRoute("/create-branch")({
  head: () => ({
    meta: [
      { title: "Add Branch — Meridian POS" },
      { name: "description", content: "Register a new branch under your business." },
      { property: "og:title", content: "Add Branch — Meridian POS" },
      { property: "og:description", content: "Create a new branch with a location and branch key." },
    ],
  }),
