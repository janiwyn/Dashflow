...
import {
  currency,
  customerDebtorNotifs,
  lowStockNotifs,
  shopDebtorNotifs,
  type CustomerDebtorNotif,
  type LowStockNotif,
  type ShopDebtorNotif,
} from "@/lib/stock-data";

export const Route = createFileRoute("/order-notifications")({
  head: () => ({
    meta: [
      { title: "Notifications — Meridian POS" },
      { name: "description", content: "Overdue debtors and low stock alerts requiring action." },
      { property: "og:title", content: "Notifications — Meridian POS" },
      { property: "og:description", content: "Review overdue debtors and low stock alerts." },
    ],
  }),
