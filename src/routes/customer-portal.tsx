...
import { branches, currency, storefrontProducts } from "@/lib/sales-ops-data";

export const Route = createFileRoute("/customer-portal")({
  head: () => ({
    meta: [
      { title: "Order Online — Meridian Retail" },
      { name: "description", content: "Browse products and place an order for pickup at your nearest Meridian Retail branch." },
      { property: "og:title", content: "Order Online — Meridian Retail" },
      { property: "og:description", content: "Browse products and order for pickup." },
    ],
  }),
