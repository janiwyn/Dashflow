...
import { businesses, admins, businessGrowth } from "@/lib/super-admin-data";

export const Route = createFileRoute("/super-report")({
  head: () => ({
    meta: [
      { title: "System Reports & Analytics — Super Admin" },
      { name: "description", content: "Platform-wide business growth, subscription health and account metrics." },
      { property: "og:title", content: "System Reports & Analytics — Super Admin" },
      { property: "og:description", content: "Platform-wide business growth, subscription health and account metrics." },
    ],
  }),
  component: SuperReportPage,
});

function SuperReportPage() {
