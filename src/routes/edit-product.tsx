...
import { stockProducts } from "@/lib/stock-data";

export const Route = createFileRoute("/edit-product")({
  head: () => ({
    meta: [
      { title: "Edit Product — Meridian POS" },
      { name: "description", content: "Update product name, pricing and stock levels." },
      { property: "og:title", content: "Edit Product — Meridian POS" },
      { property: "og:description", content: "Update product details for the catalogue." },
    ],
  }),
