...
export const metadata: Metadata = {
  ...
  description: "Full printable payslip including employee and branch information.",
};
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border text-xs uppercase tracking-[0.12em] text-muted-foreground">
              ...
              <th className="py-2 pl-8 text-left">Deductions</th>
              <th className="py-2 text-right">Amount</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border">
            <tr>
              ...
              <td className="num py-1.5 text-right">{currency(record.baseSalary)}</td>
              <td className="py-1.5 pl-8">NSSF</td>
              <td className="num py-1.5 text-right">{currency(record.nssf)}</td>
            </tr>
            <tr>
              <td className="py-1.5">Transport</td>
              <td className="num py-1.5 text-right">{currency(record.transport)}</td>
              <td className="py-1.5 pl-8">Tax (PAYE)</td>
              <td className="num py-1.5 text-right">{currency(record.tax)}</td>
            </tr>
            <tr>
              <td className="py-1.5">Housing</td>
              <td className="num py-1.5 text-right">{currency(record.housing)}</td>
              <td className="py-1.5 pl-8">Loan</td>
              <td className="num py-1.5 text-right">{currency(record.loan)}</td>
            </tr>
            <tr>
              <td className="py-1.5">Medical</td>
              <td className="num py-1.5 text-right">{currency(record.medical)}</td>
              <td className="py-1.5 pl-8">Other Deductions</td>
              <td className="num py-1.5 text-right">{currency(record.otherDeductions)}</td>
            </tr>
            <tr>
              <td className="py-1.5">Overtime</td>
              <td className="num py-1.5 text-right">{currency(record.overtime)}</td>
